    ...
    return (
        <div className="min-h-screen p-4 sm:p-6 lg:p-8">
            <div className="max-w-[1600px] mx-auto space-y-8">
                ...
                {/* Header Section */}
                <div className="bg-white dark:bg-slate-900 rounded-[2rem] p-6 shadow-xl border border-slate-200 dark:border-slate-800 relative overflow-hidden flex flex-col gap-4">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                        ...
                        <div className="flex flex-wrap gap-2 lg:gap-3">
                            <button
                                ...
                                className="px-4 py-2 lg:px-5 lg:py-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-bold rounded-xl transition-colors flex items-center gap-2"
                            >
                            ...
                            {isAdmin && (
                                <button
                                    ...
                                    className="px-4 py-2 lg:px-5 lg:py-2.5 bg-indigo-50 hover:bg-indigo-100 dark:bg-indigo-900/30 dark:hover:bg-indigo-900/50 text-indigo-600 dark:text-indigo-400 font-bold rounded-xl transition-colors flex items-center gap-2 border border-indigo-200 dark:border-indigo-800"
                                >
                                    <Shield className="w-4 h-4" /> Assign Coordinator
                                </button>
                            )}
                            ...
                            {isAuthorized && (
                                <button
                                    ...
                                    className="px-4 py-2 lg:px-5 lg:py-2.5 bg-rose-50 hover:bg-rose-100 dark:bg-rose-900/30 dark:hover:bg-rose-900/50 text-rose-600 dark:text-rose-400 font-bold rounded-xl transition-colors flex items-center gap-2 border border-rose-200 dark:border-rose-800"
                                >
                                    <RefreshCcw className="w-4 h-4" /> Reset Points
                                </button>
                            )}
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full">
                            ...
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="border-b-2 border-slate-100 dark:border-slate-800 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">
                                        ...
                                        {isAuthorized && <th className="px-5 py-4 text-right">Actions</th>}
                                    </tr>
                                </thead>
                    ...
                    <div className="w-full h-fit bg-gradient-to-br from-amber-400 to-amber-600 rounded-[2rem] p-1 shadow-xl shadow-amber-500/20 lg:sticky lg:top-24">
                        <div className="bg-white dark:bg-slate-900 rounded-[calc(2rem-4px)] h-full flex flex-col overflow-hidden">
                            ...
                            <div className="flex-1 px-5 py-4 overflow-y-auto max-h-[600px] custom-scrollbar">
                                <div className="flex flex-col gap-3">
                                    {topKickers.length === 0 ? (
                                        ...
                                        topKickers.map(t => (
                                            <div key={t.id} className="flex items-center gap-3 bg-amber-50/50 dark:bg-amber-900/10 px-4 py-3 rounded-xl border border-amber-100 dark:border-amber-900/20 w-full">
